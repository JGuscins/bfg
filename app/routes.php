    ...
    if($category == "Picture") {
        ...
        if($question->employer_3 != '') {
            ...
            if($r == 1) {
                ...
                // ANSWERS
                $q['answers'] = $category::where(DB::raw('`employer_1`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
            } elseif($r == 2) {
                $q['question'] = $question->employer_2;
                // ANSWERS
                $q['answers'] = $category::where(DB::raw('`employer_2`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
            } else {
                $q['question'] = $question->employer_3;
                // ANSWERS
                $q['answers'] = $category::where(DB::raw('`employer_3`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
            }
        ...
        if($question->school_3_name != '') {
            ...
            if($r == 1) {
                ...
                // ANSWERS
                $q['answers'] = $category::where(DB::raw('`school_1_name`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
            } elseif($r == 2) {
                $q['question'] = $question->school_2_name;
                // school_2_name
                $q['answers'] = $category::where(DB::raw('`school_2_name`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
            } else {
                $q['question'] = $question->school_3_name;
                // ANSWERS
                $q['answers'] = $category::where(DB::raw('`school_3_name`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
            }
        ...
        // ANSWERS
        $q['answers'] = $category::where(DB::raw('`book`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
        ...
        // ANSWERS
        $q['answers'] = $category::where(DB::raw('`music`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
        ...
        // ANSWERS
        $q['answers'] = $category::where(DB::raw('`movies`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
        ...
        // ANSWERS
        $q['answers'] = $category::where(DB::raw('`interests`'), DB::raw('NOT LIKE'), DB::raw("'%%".mysql_escape_string($q['question']).",%%'"))->take(3)->get();
    }
